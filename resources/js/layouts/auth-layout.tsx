...
export default function AuthLayout({ children, title, description }: Props) {
    return (
        <div className="relative grid min-h-dvh w-full flex-col items-stretch bg-white px-4 sm:px-6 lg:max-w-none lg:grid-cols-2 lg:px-0">
            ...
            <div className="absolute top-0 left-0 z-10 h-1 w-full bg-gradient-to-r from-green-900 via-green-600 to-green-500" />
